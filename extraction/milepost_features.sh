...
cp $2 /home/data/plag-detect-psrl/extraction/
bash /home/data/plag-detect-psrl/extraction/_use_ctuning_cc_directly_extract_features.sh >	/home/data/plag-detect-psrl/extraction/tmplog.txt 2>&1
grep "error" /home/data/plag-detect-psrl/extraction/tmplog.txt && echo $(basename $2) >> /home/data/plag-detect-psrl/extraction/error_log.txt
for j in /tmp/ici_features_function* ; do
	mv $j /home/data/plag-detect-psrl/extraction/result_$1/milepost_features/$(basename $2)_$(basename $j)
done
rm -f /home/data/plag-detect-psrl/extraction/$(basename $2)
rm -rf /tmp/
echo "Finished $(basename $2)"

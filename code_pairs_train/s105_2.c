...
int main()
{
    ...
    for (tc_loop_index=0; tc_loop_index<tc; tc_loop_index++)
    {
		...
		while ( current_starting_range < m )
		{
            ...
            if (ranges[current_starting_range].a <= ranges[current_starting_range].b )
	{
		current_value =  ranges[current_starting_range].a+current_starting_range_offset;
	}
	else if ( current_starting_range_offset <= ranges[current_starting_range].b )
	{
		current_value =  current_starting_range_offset;
	}
	else
	{
		current_value =  ranges[current_starting_range].a + current_starting_range_offset - ranges[current_starting_range].b + 1;
	}

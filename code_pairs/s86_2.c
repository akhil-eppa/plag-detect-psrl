...
unsigned short T;
    ...
    unsigned long long K, jump;
    unsigned long long result, till;
    unsigned long long count, overlap, elements;
...
void main()
{
    ...
    while(T--)
    {
        ...
        count = 0; overlap = 0; till = 0; elements = 0;
        unsigned long long sum = 0, sumArray = 0, right = 0;
        unsigned long A[N];
        left = 0; j = 0;
        first = true; change = true; stop = true;
